...
**Resources:** One of the great things about R is that it is open-source. Like
  ...
  * Chacon, S., and Straub, B. (2014). *Pro Git: Everything you need to know 
      about git*. (2nd edition). Available online at 
...
#### Week 2.2: Basic plotting & routine function
...
#### Week 3.2: Data structures and classes
...
#### Week 4.1: Transforming & manipulating data
